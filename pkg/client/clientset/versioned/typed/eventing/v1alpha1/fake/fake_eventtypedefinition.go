...
func (c *FakeEventTypeDefinitions) UpdateStatus(ctx context.Context, eventTypeDefinition *v1alpha1.EventTypeDefinition, opts v1.UpdateOptions) (*v1alpha1.EventTypeDefinition, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(eventtypedefinitionsResource, "status", c.ns, eventTypeDefinition), &v1alpha1.EventTypeDefinition{})
