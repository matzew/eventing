...
type EventTypeDefinitionInterface interface {
	...
	UpdateStatus(ctx context.Context, eventTypeDefinition *v1alpha1.EventTypeDefinition, opts v1.UpdateOptions) (*v1alpha1.EventTypeDefinition, error)
...
func (c *eventTypeDefinitions) UpdateStatus(ctx context.Context, eventTypeDefinition *v1alpha1.EventTypeDefinition, opts v1.UpdateOptions) (result *v1alpha1.EventTypeDefinition, err error) {
	result = &v1alpha1.EventTypeDefinition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventtypedefinitions").
