...
type EventTypeDefinitionSpec struct {
	...
	Type string `json:"type"` // Or ID, instead of type?
	...
	// +optional
	SchemaURL *apis.URL `json:"schema,omitempty"`
	...
	Metadata EventTypeDefinitionMetadata `json:"metadata"`
}

type EventTypeDefinitionMetadata struct {
	Attributes map[string]EventTypeDefinitionAttribute `json:"attributes"`
}
